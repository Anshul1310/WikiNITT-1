...
export type GetMeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, username: string, displayName: string, avatar: string, isAdmin: boolean, groups: Array<{ __typename?: 'Group', id: string, name: string, slug: string, membersCount: number, icon?: string | null }> } };
