...
export default function ArticleView({ data }: { data: Article }) {
  ...
  return (
    <div className="bg-[#f3f3ff] text-[#333] font-[var(--font-lato)] text-[16px] leading-[1.6] animate-[fadeInPage_0.8s_ease-out_forwards]">
      
      {/* Title Section */}
      <section className="bg-[#2d2d2d] text-white px-[5%] md:px-[20px] pb-[25px] pt-[15px] flex justify-center">
        <h1 className="font-[var(--font-kaisei)] text-[1.8rem] md:text-[2.2rem] font-bold mt-[10px] w-full max-w-[1050px] animate-[slideUpFade_0.8s_ease-out_0.2s_backwards] text-center md:text-left leading-tight">
          {data.title}
        </h1>
      </section>
      ...
      {/* Main Content (Perfectly Centered Article with TOC in left margin) */}
      <main className="w-full mt-[25px] md:mt-[40px] px-[5%] md:px-[20px] animate-[slideUpFade_0.8s_ease-out_0.6s_backwards] relative pb-10">
        <div className="flex justify-center max-w-[1400px] mx-auto w-full">
          ...
          {/* STICKY SIDEBAR: Absolute left space */}
          <aside className="hidden lg:block sticky top-[90px] self-start w-[220px] shrink-0 mr-[40px] xl:mr-[80px] max-h-[calc(100vh-120px)] overflow-y-auto custom-scrollbar pr-2">
            <h3 className="font-[var(--font-kaisei)] font-bold text-[1.1rem] mb-[15px] text-[#444] pb-[5px] inline-block">
              Contents
            </h3>
            <ul className="list-none p-0 m-0 border-l border-[#d0d2df] pl-3 flex flex-col gap-[12px]">
              {headings.map((heading, index) => (
                <li
                  ...
                  className={`text-[0.9rem] cursor-pointer transition-all duration-200 relative left-0 hover:text-[#333] hover:left-[3px] ${
                    activeHeading === heading.id ? "text-[#333] font-bold" : "text-[#777]"
                  }`}
                >
                  {heading.text}
                </li>
          ...
          {/* ARTICLE CONTENT: Perfectly Centered */}
          ...
          {/* INVISIBLE RIGHT SPACER: This balances the left sidebar so the article achieves true mathematical centering */}
      ...
      <style jsx global>{`
         ...
         */
        .article-markdown .wmde-markdown h1 a.anchor,
        .article-markdown .wmde-markdown h2 a.anchor,
        .article-markdown .wmde-markdown h3 a.anchor,
        .article-markdown .wmde-markdown h4 a.anchor,
        .article-markdown .wmde-markdown h5 a.anchor,
        .article-markdown .wmde-markdown h6 a.anchor {
          display: none !important;
        }

        /* Prevent our custom link underline from applying to heading anchors just in case */
        .article-markdown .wmde-markdown h1 a::after,
        .article-markdown .wmde-markdown h2 a::after,
        .article-markdown .wmde-markdown h3 a::after,
        .article-markdown .wmde-markdown h4 a::after {
          display: none !important;
        }
        ...
        .article-markdown .wmde-markdown h2:first-child {
          margin-top: 0 !important;
        }

        .article-markdown .wmde-markdown p {
        ...
        .article-markdown .wmde-markdown img {
        ...
        .article-markdown .wmde-markdown a {
        ...
        .article-markdown .wmde-markdown a::after {
          content: '';
          position: absolute;
          width: 100%;
          height: 1.5px;
        ...
        .article-markdown .wmde-markdown a:hover::after {
          transform: scaleX(1);
